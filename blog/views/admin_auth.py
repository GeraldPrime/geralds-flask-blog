from flask import Blueprint, render_template, request, flash, get_flashed_messages, redirect, session
...
def logout_admin():
    session.pop("ADMIN_LOGIN")
    flash("Logout Successful", "success")
    return redirect("/owner/")

# VIEW DASHBOARD PAGE
@admin_auth.get("/dashboard")
@authenticate
def dashboard_page():
